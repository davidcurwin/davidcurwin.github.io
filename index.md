...
<div class="cards">
  <div class="card">
    ...
    <div class="btnrow"><a class="btn" href="{{ '/kohelet/' | relative_url }}">Go to Kohelet page</a></div>
  </div>
  <div class="card">
    <h3>Essays</h3>
    <div class="muted">Links to published essays and articles on Tanakh (Hebrew Bible) and Jewish Thought.</div>
    <div class="btnrow"><a class="btn" href="{{ '/essays/' | relative_url }}">Browse essays</a></div>
  </div>
  <div class="card">
    <h3>Balashon</h3>
